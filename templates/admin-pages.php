                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12 form-group">
                                ...
                                <input id ="filter" type="text" class="form-control" placeholder="filter Pages...">
                            </div>
                        </div>
                        <table class="table  table-hover" id="pages">
                            <thead class="thead-dark">
                                <tr>
                                    <th class="defaultUpDown" scope="col" style="width:30%">Title</th>
                                    <th scope="col">Published</th>
                                    <th class="defaultUpDown" scope="col">Created</th>
                                    <th></th>
                                </tr>
                            </thead>
                            <tbody>
                                ...
                                <tr>
                                    <td id="title"><?php echo $page->page_title?></td>
                                    ...
                                    <td><a class="btn btn-secondary mr-2" href="edit-page.php?id=<?php echo $page->id;?>">Edit</a>
                                        <form style="display:inline" method="post" action="pages.php">
