...
<nav aria-label="breadcrumb">
    <div class="container-fluid">
        ...
        <li class="breadcrumb-item active" aria-current="post">Post</li>
        </ol>
    </div>
</nav>
<section id="main">
                    ...
                    <div class="card-body">
                        ...
                        <table class="table  table-hover" id="posts">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td id="title"><?php echo $post->post_title?></td>
                                    ...
                                    <td><a class="btn btn-secondary mr-2" href="edit-post.php?id=<?php echo $post->id;?>">Edit</a>
                                        <form style="display:inline" method="post" action="posts.php">
